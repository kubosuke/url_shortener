defmodule Hello.Visit.Worker do
  ...
  defp get_continent_from_ip(ip) do
    ...
    Logger.debug(
      "Continent: #{Map.get(@country_code_to_continent, String.to_atom(country_code), "Unknown")} converted from #{country_code}"
    )

    Map.get(@country_code_to_continent, String.to_atom(country_code), "Unknown")
  end
end
